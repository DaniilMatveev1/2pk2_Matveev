...
namespace SnakeGame
{
    ...
    class Program
    {
        ...
        class SnakeGame
        {
            // размер поля и обозначение препятствий а так же бомб и самой змейки
            ...
            public SnakeGame()
            {
                // рандомное расположение а так же количество бомб и препятствий 
            ...
            {
                // расположение змейки в середине поля
                int centerX = width / 2;
            ...
            private void Move()
            {
                ...
                {
                    // змейка съела еду и сколько получает счета 
                    score += 5;
                    GenerateFood();
                }
                else
                {
                    // удаляем конца змейки
                    var tail = snake.Last();
                    DrawPoint(tail, ' ');
                    snake.Remove(tail);
                }
